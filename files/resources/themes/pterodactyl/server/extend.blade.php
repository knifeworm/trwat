...
@section('content')
<form method="POST" action="{{ route('server.extend.server', $server->uuidShort) }}">
  <div class="row">
  	<div class="col-md-9">
          <div class="box">
                          ...
                          <tbody>
                              ...
                              @foreach ($billing as $setting)
                                  @foreach (Session::get('cart-extend') as $cart)
                                      @if (end($cart)['name'] == 'Extend Server '. $server->id || end($cart)['name'] == 'Promotional Code')
                                      <tr>
    ...
    <div class="col-md-9"></div>
  	<div class="col-md-3">
          <div class="box">
              ...
              <form method="POST" action="{{ route('server.extend.promotional', $server->uuidShort) }}">
                <div class="box-body">
                	<div class="col-md-12">
    	            	<div class="row">
    		            	<div class="col-md-12">
