...
<div class="row">
  ...
  <form method="POST" action="{{ route('admin.billing.products.store') }}">
    <div class="col-xs-12">
        ...
        <div class="box-body">
            <div class="row">
              ...
              <div class="form-group col-md-4">
                ...
                <div>
                  <input type="text" class="form-control" name="price" placeholder="5.00">
                </div>
              </div>
              <div class="form-group col-md-4">
                <label class="control-label">Description</label>
                <div>
                  <input type="text" class="form-control" name="description" placeholder="For Minecraft Servers">
                </div>
              </div>
            ...
            <div class="row">
              <div class="form-group col-md-4">
                ...
                <select name="egg_id" class="form-control">
                  @foreach ($eggs as $egg)
                    <option value="{{ $egg->id }}">({{ $egg->id }}) {{ $egg->name }}</option>
                  @endforeach
                </select>
              </div>
              <div class="form-group col-md-4">
              ...
              <div class="form-group col-md-4">
                ...
                <div>
                  <input type="text" class="form-control" name="memory" value="1024">
                </div>
              </div>
            </div>
          </div>
          ...
          <div class="box-body">
            <div class="row">
              <div class="form-group col-md-4">
                ...
                <div>
                  <input type="number" class="form-control" name="cpu" value="100">
                </div>
              </div>
              <div class="form-group col-md-4">
                <label class="control-label">Block IO Weight</label>
                <div>
                  <input type="number" class="form-control" name="io" value="500">
                </div>
              </div>
              <div class="form-group col-md-4">
                <label class="control-label">Disk (in MB)</label>
                <div>
                  <input type="number" class="form-control" name="disk" value="12000">
                </div>
              </div>
            </div>
          </div>
        ...
        <div class="box-body">
            <div class="row">
              <div class="form-group col-md-6">
                ...
                <div>
                  <input type="number" class="form-control" name="database_limit" value="0">
                </div>
              ...
              <div class="form-group col-md-6">
                ...
                <div>
                  <input type="number" class="form-control" name="allocation_limit" value="0">
                </div>
